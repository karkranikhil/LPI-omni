...
import { OMNIDEF } from './lPIDriverEnglish_def.js';
import tmpl from './lPIDriverEnglish.html';
import tmpl_nds from './lPIDriverEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIDriverEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
