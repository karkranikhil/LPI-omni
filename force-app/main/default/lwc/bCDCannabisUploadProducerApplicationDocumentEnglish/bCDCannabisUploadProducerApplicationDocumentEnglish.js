...
import { OMNIDEF } from './bCDCannabisUploadProducerApplicationDocumentEnglish_def.js';
import tmpl from './bCDCannabisUploadProducerApplicationDocumentEnglish.html';
import tmpl_nds from './bCDCannabisUploadProducerApplicationDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisUploadProducerApplicationDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
