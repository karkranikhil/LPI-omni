import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfMtxlpi_fc_ContEduTableRowData_RenewalPsy extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfMtxlpi_fc_ContEduTableRowData_RenewalPsy';
        ...
        pubsub.register(`mtxlpi_fc_ContEduTableRowData_RenewalPsy`,this.pubsubEvent[0]);
        ...
        pubsub.register(`pubsubreload`,this.pubsubEvent[1]);
              ...
              unregisterEvents(){
                pubsub.unregister(`mtxlpi_fc_ContEduTableRowData_RenewalPsy`,this.pubsubEvent[0]);
