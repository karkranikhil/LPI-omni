...
import { OMNIDEF } from './bCDAccountancyIntakeFormEnglish_def.js';
import tmpl from './bCDAccountancyIntakeFormEnglish.html';
import tmpl_nds from './bCDAccountancyIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAccountancyIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
