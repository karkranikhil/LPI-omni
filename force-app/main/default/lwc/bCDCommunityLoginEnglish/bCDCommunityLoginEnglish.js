...
import { OMNIDEF } from './bCDCommunityLoginEnglish_def.js';
import tmpl from './bCDCommunityLoginEnglish.html';
import tmpl_nds from './bCDCommunityLoginEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCommunityLoginEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
