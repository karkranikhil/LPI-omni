...
import { OMNIDEF } from './bCDJPExamPaymentEnglish_def.js';
import tmpl from './bCDJPExamPaymentEnglish.html';
import tmpl_nds from './bCDJPExamPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDJPExamPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
