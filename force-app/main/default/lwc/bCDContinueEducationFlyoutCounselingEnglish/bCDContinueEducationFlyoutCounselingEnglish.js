...
import { OMNIDEF } from './bCDContinueEducationFlyoutCounselingEnglish_def.js';
import tmpl from './bCDContinueEducationFlyoutCounselingEnglish.html';
import tmpl_nds from './bCDContinueEducationFlyoutCounselingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDContinueEducationFlyoutCounselingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
