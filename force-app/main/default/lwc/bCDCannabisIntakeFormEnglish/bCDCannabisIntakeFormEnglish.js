...
import { OMNIDEF } from './bCDCannabisIntakeFormEnglish_def.js';
import tmpl from './bCDCannabisIntakeFormEnglish.html';
import tmpl_nds from './bCDCannabisIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
