...
import { OMNIDEF } from './bCDSurveyresultformEnglish_def.js';
import tmpl from './bCDSurveyresultformEnglish.html';
import tmpl_nds from './bCDSurveyresultformEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDSurveyresultformEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
