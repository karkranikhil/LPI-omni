...
import { OMNIDEF } from './bCDPsychologyIntakeFormEnglish_def.js';
import tmpl from './bCDPsychologyIntakeFormEnglish.html';
import tmpl_nds from './bCDPsychologyIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPsychologyIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
