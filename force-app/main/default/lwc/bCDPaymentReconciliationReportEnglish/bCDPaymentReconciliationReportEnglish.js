...
import { OMNIDEF } from './bCDPaymentReconciliationReportEnglish_def.js';
import tmpl from './bCDPaymentReconciliationReportEnglish.html';
import tmpl_nds from './bCDPaymentReconciliationReportEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPaymentReconciliationReportEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
