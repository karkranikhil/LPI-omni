...
import { OMNIDEF } from './bCDInspectionRequestEnglish_def.js';
import tmpl from './bCDInspectionRequestEnglish.html';
import tmpl_nds from './bCDInspectionRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDInspectionRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
