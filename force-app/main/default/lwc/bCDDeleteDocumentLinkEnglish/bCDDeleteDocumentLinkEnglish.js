...
import { OMNIDEF } from './bCDDeleteDocumentLinkEnglish_def.js';
import tmpl from './bCDDeleteDocumentLinkEnglish.html';
import tmpl_nds from './bCDDeleteDocumentLinkEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDeleteDocumentLinkEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
