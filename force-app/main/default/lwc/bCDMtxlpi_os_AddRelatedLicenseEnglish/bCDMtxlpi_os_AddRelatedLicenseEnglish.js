...
import { OMNIDEF } from './bCDMtxlpi_os_AddRelatedLicenseEnglish_def.js';
import tmpl from './bCDMtxlpi_os_AddRelatedLicenseEnglish.html';
import tmpl_nds from './bCDMtxlpi_os_AddRelatedLicenseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMtxlpi_os_AddRelatedLicenseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
