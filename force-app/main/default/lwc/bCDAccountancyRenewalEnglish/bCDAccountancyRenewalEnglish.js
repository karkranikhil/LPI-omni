...
import { OMNIDEF } from './bCDAccountancyRenewalEnglish_def.js';
import tmpl from './bCDAccountancyRenewalEnglish.html';
import tmpl_nds from './bCDAccountancyRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAccountancyRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
