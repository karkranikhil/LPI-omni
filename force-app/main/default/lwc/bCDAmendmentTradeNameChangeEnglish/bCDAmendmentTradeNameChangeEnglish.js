...
import { OMNIDEF } from './bCDAmendmentTradeNameChangeEnglish_def.js';
import tmpl from './bCDAmendmentTradeNameChangeEnglish.html';
import tmpl_nds from './bCDAmendmentTradeNameChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAmendmentTradeNameChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
