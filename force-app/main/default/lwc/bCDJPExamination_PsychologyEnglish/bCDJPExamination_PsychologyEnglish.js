...
import { OMNIDEF } from './bCDJPExamination_PsychologyEnglish_def.js';
import tmpl from './bCDJPExamination_PsychologyEnglish.html';
import tmpl_nds from './bCDJPExamination_PsychologyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDJPExamination_PsychologyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
