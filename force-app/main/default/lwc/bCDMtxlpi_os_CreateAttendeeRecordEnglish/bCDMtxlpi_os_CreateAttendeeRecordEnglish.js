...
import { OMNIDEF } from './bCDMtxlpi_os_CreateAttendeeRecordEnglish_def.js';
import tmpl from './bCDMtxlpi_os_CreateAttendeeRecordEnglish.html';
import tmpl_nds from './bCDMtxlpi_os_CreateAttendeeRecordEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMtxlpi_os_CreateAttendeeRecordEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
