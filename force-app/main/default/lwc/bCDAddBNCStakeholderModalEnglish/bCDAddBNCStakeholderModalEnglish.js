...
import { OMNIDEF } from './bCDAddBNCStakeholderModalEnglish_def.js';
import tmpl from './bCDAddBNCStakeholderModalEnglish.html';
import tmpl_nds from './bCDAddBNCStakeholderModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAddBNCStakeholderModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
