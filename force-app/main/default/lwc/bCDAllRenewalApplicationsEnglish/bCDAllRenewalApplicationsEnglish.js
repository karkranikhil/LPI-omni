...
import { OMNIDEF } from './bCDAllRenewalApplicationsEnglish_def.js';
import tmpl from './bCDAllRenewalApplicationsEnglish.html';
import tmpl_nds from './bCDAllRenewalApplicationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAllRenewalApplicationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
