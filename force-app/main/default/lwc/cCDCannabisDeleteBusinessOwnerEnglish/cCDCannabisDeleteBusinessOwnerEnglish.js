...
import { OMNIDEF } from './cCDCannabisDeleteBusinessOwnerEnglish_def.js';
import tmpl from './cCDCannabisDeleteBusinessOwnerEnglish.html';
import tmpl_nds from './cCDCannabisDeleteBusinessOwnerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisDeleteBusinessOwnerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
