...
import { OMNIDEF } from './bCDSocialWorkIntakeFormEnglish_def.js';
import tmpl from './bCDSocialWorkIntakeFormEnglish.html';
import tmpl_nds from './bCDSocialWorkIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDSocialWorkIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
