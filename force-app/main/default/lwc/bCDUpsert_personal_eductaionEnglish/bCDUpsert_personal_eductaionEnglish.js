...
import { OMNIDEF } from './bCDUpsert_personal_eductaionEnglish_def.js';
import tmpl from './bCDUpsert_personal_eductaionEnglish.html';
import tmpl_nds from './bCDUpsert_personal_eductaionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDUpsert_personal_eductaionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
