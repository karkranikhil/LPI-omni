...
import { OMNIDEF } from './lPISummonFlowEnglish_def.js';
import tmpl from './lPISummonFlowEnglish.html';
import tmpl_nds from './lPISummonFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPISummonFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
