...
import { OMNIDEF } from './lPIVehicle_PublicEnglish_def.js';
import tmpl from './lPIVehicle_PublicEnglish.html';
import tmpl_nds from './lPIVehicle_PublicEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIVehicle_PublicEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
