...
import { OMNIDEF } from './bCDComprehensiveLicenseSearchEnglish_def.js';
import tmpl from './bCDComprehensiveLicenseSearchEnglish.html';
import tmpl_nds from './bCDComprehensiveLicenseSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDComprehensiveLicenseSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
