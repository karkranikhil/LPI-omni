...
import { OMNIDEF } from './bCDCannabisDeleteApplicationDocumentEnglish_def.js';
import tmpl from './bCDCannabisDeleteApplicationDocumentEnglish.html';
import tmpl_nds from './bCDCannabisDeleteApplicationDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisDeleteApplicationDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
