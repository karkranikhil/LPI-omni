...
import { OMNIDEF } from './bCDContinueEducationFlyoutPsyEnglish_def.js';
import tmpl from './bCDContinueEducationFlyoutPsyEnglish.html';
import tmpl_nds from './bCDContinueEducationFlyoutPsyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDContinueEducationFlyoutPsyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
