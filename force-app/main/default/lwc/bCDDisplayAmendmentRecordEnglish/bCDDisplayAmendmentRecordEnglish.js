...
import { OMNIDEF } from './bCDDisplayAmendmentRecordEnglish_def.js';
import tmpl from './bCDDisplayAmendmentRecordEnglish.html';
import tmpl_nds from './bCDDisplayAmendmentRecordEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDisplayAmendmentRecordEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
