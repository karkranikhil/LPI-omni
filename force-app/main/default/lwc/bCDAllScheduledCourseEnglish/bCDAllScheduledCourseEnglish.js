...
import { OMNIDEF } from './bCDAllScheduledCourseEnglish_def.js';
import tmpl from './bCDAllScheduledCourseEnglish.html';
import tmpl_nds from './bCDAllScheduledCourseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAllScheduledCourseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
