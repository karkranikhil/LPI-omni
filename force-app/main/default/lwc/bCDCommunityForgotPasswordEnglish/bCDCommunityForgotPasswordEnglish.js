...
import { OMNIDEF } from './bCDCommunityForgotPasswordEnglish_def.js';
import tmpl from './bCDCommunityForgotPasswordEnglish.html';
import tmpl_nds from './bCDCommunityForgotPasswordEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCommunityForgotPasswordEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
