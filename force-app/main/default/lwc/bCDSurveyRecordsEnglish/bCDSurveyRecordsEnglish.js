...
import { OMNIDEF } from './bCDSurveyRecordsEnglish_def.js';
import tmpl from './bCDSurveyRecordsEnglish.html';
import tmpl_nds from './bCDSurveyRecordsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDSurveyRecordsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
