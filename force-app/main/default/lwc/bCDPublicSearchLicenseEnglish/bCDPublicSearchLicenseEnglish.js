...
import { OMNIDEF } from './bCDPublicSearchLicenseEnglish_def.js';
import tmpl from './bCDPublicSearchLicenseEnglish.html';
import tmpl_nds from './bCDPublicSearchLicenseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPublicSearchLicenseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
