...
import { OMNIDEF } from './cCDCannabisBusinessOwnerDetailsEnglish_def.js';
import tmpl from './cCDCannabisBusinessOwnerDetailsEnglish.html';
import tmpl_nds from './cCDCannabisBusinessOwnerDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisBusinessOwnerDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
