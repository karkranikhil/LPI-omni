...
import { OMNIDEF } from './bCDShowMyApplicantsRecordsEnglish_def.js';
import tmpl from './bCDShowMyApplicantsRecordsEnglish.html';
import tmpl_nds from './bCDShowMyApplicantsRecordsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDShowMyApplicantsRecordsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
