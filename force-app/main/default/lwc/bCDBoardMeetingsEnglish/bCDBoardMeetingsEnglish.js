...
import { OMNIDEF } from './bCDBoardMeetingsEnglish_def.js';
import tmpl from './bCDBoardMeetingsEnglish.html';
import tmpl_nds from './bCDBoardMeetingsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBoardMeetingsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
