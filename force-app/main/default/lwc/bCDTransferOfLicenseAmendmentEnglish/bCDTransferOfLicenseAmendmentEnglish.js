...
import { OMNIDEF } from './bCDTransferOfLicenseAmendmentEnglish_def.js';
import tmpl from './bCDTransferOfLicenseAmendmentEnglish.html';
import tmpl_nds from './bCDTransferOfLicenseAmendmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDTransferOfLicenseAmendmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
