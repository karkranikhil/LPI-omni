...
import { OMNIDEF } from './cCDCannabisWithdrawApplicationEnglish_def.js';
import tmpl from './cCDCannabisWithdrawApplicationEnglish.html';
import tmpl_nds from './cCDCannabisWithdrawApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisWithdrawApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
