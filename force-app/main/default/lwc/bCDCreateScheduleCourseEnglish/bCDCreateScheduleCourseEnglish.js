...
import { OMNIDEF } from './bCDCreateScheduleCourseEnglish_def.js';
import tmpl from './bCDCreateScheduleCourseEnglish.html';
import tmpl_nds from './bCDCreateScheduleCourseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCreateScheduleCourseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
