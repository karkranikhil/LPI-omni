...
import { OMNIDEF } from './bCDMyRequestEnglish_def.js';
import tmpl from './bCDMyRequestEnglish.html';
import tmpl_nds from './bCDMyRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMyRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
