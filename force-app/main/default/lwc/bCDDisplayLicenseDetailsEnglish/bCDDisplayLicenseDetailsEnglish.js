...
import { OMNIDEF } from './bCDDisplayLicenseDetailsEnglish_def.js';
import tmpl from './bCDDisplayLicenseDetailsEnglish.html';
import tmpl_nds from './bCDDisplayLicenseDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDisplayLicenseDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
