...
import { OMNIDEF } from './cCDCannabisDeletePremisesEnglish_def.js';
import tmpl from './cCDCannabisDeletePremisesEnglish.html';
import tmpl_nds from './cCDCannabisDeletePremisesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisDeletePremisesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
