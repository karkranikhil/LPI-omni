...
import { OMNIDEF } from './tLCCreateSettlementAndNavigateEnglish_def.js';
import tmpl from './tLCCreateSettlementAndNavigateEnglish.html';
import tmpl_nds from './tLCCreateSettlementAndNavigateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tLCCreateSettlementAndNavigateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
