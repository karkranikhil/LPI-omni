...
import { OMNIDEF } from './bCDSelectLicensePageEnglish_def.js';
import tmpl from './bCDSelectLicensePageEnglish.html';
import tmpl_nds from './bCDSelectLicensePageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDSelectLicensePageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
