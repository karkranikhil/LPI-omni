...
import { OMNIDEF } from './bCDCounsellingRenewalEnglish_def.js';
import tmpl from './bCDCounsellingRenewalEnglish.html';
import tmpl_nds from './bCDCounsellingRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCounsellingRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
