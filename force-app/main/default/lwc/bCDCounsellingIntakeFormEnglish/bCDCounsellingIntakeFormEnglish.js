...
import { OMNIDEF } from './bCDCounsellingIntakeFormEnglish_def.js';
import tmpl from './bCDCounsellingIntakeFormEnglish.html';
import tmpl_nds from './bCDCounsellingIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCounsellingIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
