...
import { OMNIDEF } from './bCDCannabisUploadApplicationDocumentEnglish_def.js';
import tmpl from './bCDCannabisUploadApplicationDocumentEnglish.html';
import tmpl_nds from './bCDCannabisUploadApplicationDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisUploadApplicationDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
