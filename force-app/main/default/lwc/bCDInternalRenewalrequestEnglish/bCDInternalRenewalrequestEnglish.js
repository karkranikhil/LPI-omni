...
import { OMNIDEF } from './bCDInternalRenewalrequestEnglish_def.js';
import tmpl from './bCDInternalRenewalrequestEnglish.html';
import tmpl_nds from './bCDInternalRenewalrequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDInternalRenewalrequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
