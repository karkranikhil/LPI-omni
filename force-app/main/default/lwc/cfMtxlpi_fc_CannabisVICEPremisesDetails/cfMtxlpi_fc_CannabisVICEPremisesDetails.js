import { FlexCardMixin } from "vlocity_ins/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_ins/flexCardUtility";
          ...
          export default class cfMtxlpi_fc_CannabisVICEPremisesDetails extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfMtxlpi_fc_CannabisVICEPremisesDetails';
...
data: this.handleEventAction.bind(this, data.events[4],4)
        ...
        pubsub.register(`mtxlpi_fc_CannabisVICEPremisesDetails`,this.pubsubEvent[0]);
        ...
        pubsub.register(`newreload`,this.pubsubEvent[3]);
              ...
              unregisterEvents(){
                pubsub.unregister(`mtxlpi_fc_CannabisVICEPremisesDetails`,this.pubsubEvent[0]);
