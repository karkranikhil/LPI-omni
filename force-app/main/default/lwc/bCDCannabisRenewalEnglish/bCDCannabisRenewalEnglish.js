...
import { OMNIDEF } from './bCDCannabisRenewalEnglish_def.js';
import tmpl from './bCDCannabisRenewalEnglish.html';
import tmpl_nds from './bCDCannabisRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
