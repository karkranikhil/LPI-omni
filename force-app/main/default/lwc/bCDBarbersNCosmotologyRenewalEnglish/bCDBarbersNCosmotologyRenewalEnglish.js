...
import { OMNIDEF } from './bCDBarbersNCosmotologyRenewalEnglish_def.js';
import tmpl from './bCDBarbersNCosmotologyRenewalEnglish.html';
import tmpl_nds from './bCDBarbersNCosmotologyRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBarbersNCosmotologyRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
