...
import { OMNIDEF } from './lPIVehicleEnglish_def.js';
import tmpl from './lPIVehicleEnglish.html';
import tmpl_nds from './lPIVehicleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIVehicleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
