...
import { OMNIDEF } from './bCDBusinessLicenseAddressChangeEnglish_def.js';
import tmpl from './bCDBusinessLicenseAddressChangeEnglish.html';
import tmpl_nds from './bCDBusinessLicenseAddressChangeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBusinessLicenseAddressChangeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
