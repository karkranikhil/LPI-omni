...
import { OMNIDEF } from './bCDConfirmationPageEnglish_def.js';
import tmpl from './bCDConfirmationPageEnglish.html';
import tmpl_nds from './bCDConfirmationPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDConfirmationPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
