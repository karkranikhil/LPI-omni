...
import { OMNIDEF } from './bCDAmendmentRequestEnglish_def.js';
import tmpl from './bCDAmendmentRequestEnglish.html';
import tmpl_nds from './bCDAmendmentRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAmendmentRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
