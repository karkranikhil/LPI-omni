...
import { OMNIDEF } from './bCDPublicComplaintCCDEnglish_def.js';
import tmpl from './bCDPublicComplaintCCDEnglish.html';
import tmpl_nds from './bCDPublicComplaintCCDEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPublicComplaintCCDEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
