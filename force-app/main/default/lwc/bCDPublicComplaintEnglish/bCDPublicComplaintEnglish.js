...
import { OMNIDEF } from './bCDPublicComplaintEnglish_def.js';
import tmpl from './bCDPublicComplaintEnglish.html';
import tmpl_nds from './bCDPublicComplaintEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPublicComplaintEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
