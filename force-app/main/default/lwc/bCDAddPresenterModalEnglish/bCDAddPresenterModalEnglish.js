...
import { OMNIDEF } from './bCDAddPresenterModalEnglish_def.js';
import tmpl from './bCDAddPresenterModalEnglish.html';
import tmpl_nds from './bCDAddPresenterModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAddPresenterModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
