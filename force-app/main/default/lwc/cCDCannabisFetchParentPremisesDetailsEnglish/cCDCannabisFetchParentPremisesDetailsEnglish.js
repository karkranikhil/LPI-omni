...
import { OMNIDEF } from './cCDCannabisFetchParentPremisesDetailsEnglish_def.js';
import tmpl from './cCDCannabisFetchParentPremisesDetailsEnglish.html';
import tmpl_nds from './cCDCannabisFetchParentPremisesDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisFetchParentPremisesDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
