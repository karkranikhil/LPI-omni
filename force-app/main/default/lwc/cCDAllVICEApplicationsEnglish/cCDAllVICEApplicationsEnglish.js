...
import { OMNIDEF } from './cCDAllVICEApplicationsEnglish_def.js';
import tmpl from './cCDAllVICEApplicationsEnglish.html';
import tmpl_nds from './cCDAllVICEApplicationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDAllVICEApplicationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
