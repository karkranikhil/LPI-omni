...
import { OMNIDEF } from './bCDMtxlpi_os_selectExistingApplicationDoocumentEnglish_def.js';
import tmpl from './bCDMtxlpi_os_selectExistingApplicationDoocumentEnglish.html';
import tmpl_nds from './bCDMtxlpi_os_selectExistingApplicationDoocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMtxlpi_os_selectExistingApplicationDoocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
