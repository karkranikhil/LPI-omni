...
import { OMNIDEF } from './bCDAddSupervisorModalEnglish_def.js';
import tmpl from './bCDAddSupervisorModalEnglish.html';
import tmpl_nds from './bCDAddSupervisorModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAddSupervisorModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
