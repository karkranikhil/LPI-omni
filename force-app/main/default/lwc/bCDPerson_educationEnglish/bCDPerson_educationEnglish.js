...
import { OMNIDEF } from './bCDPerson_educationEnglish_def.js';
import tmpl from './bCDPerson_educationEnglish.html';
import tmpl_nds from './bCDPerson_educationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPerson_educationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
