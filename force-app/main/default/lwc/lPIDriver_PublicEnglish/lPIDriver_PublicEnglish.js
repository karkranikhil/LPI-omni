...
import { OMNIDEF } from './lPIDriver_PublicEnglish_def.js';
import tmpl from './lPIDriver_PublicEnglish.html';
import tmpl_nds from './lPIDriver_PublicEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIDriver_PublicEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
