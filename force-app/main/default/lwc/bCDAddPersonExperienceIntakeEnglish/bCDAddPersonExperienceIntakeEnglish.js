...
import { OMNIDEF } from './bCDAddPersonExperienceIntakeEnglish_def.js';
import tmpl from './bCDAddPersonExperienceIntakeEnglish.html';
import tmpl_nds from './bCDAddPersonExperienceIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAddPersonExperienceIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
