...
import { OMNIDEF } from './tLCCreateHearingAndNavigateEnglish_def.js';
import tmpl from './tLCCreateHearingAndNavigateEnglish.html';
import tmpl_nds from './tLCCreateHearingAndNavigateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tLCCreateHearingAndNavigateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
