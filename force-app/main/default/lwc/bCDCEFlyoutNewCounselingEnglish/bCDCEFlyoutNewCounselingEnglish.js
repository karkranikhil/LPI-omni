...
import { OMNIDEF } from './bCDCEFlyoutNewCounselingEnglish_def.js';
import tmpl from './bCDCEFlyoutNewCounselingEnglish.html';
import tmpl_nds from './bCDCEFlyoutNewCounselingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCEFlyoutNewCounselingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
