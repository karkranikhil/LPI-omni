...
import { OMNIDEF } from './cCDCannabisPremisesDetailsEnglish_def.js';
import tmpl from './cCDCannabisPremisesDetailsEnglish.html';
import tmpl_nds from './cCDCannabisPremisesDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisPremisesDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
