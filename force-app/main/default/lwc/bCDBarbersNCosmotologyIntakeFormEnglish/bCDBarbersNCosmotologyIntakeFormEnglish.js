...
import { OMNIDEF } from './bCDBarbersNCosmotologyIntakeFormEnglish_def.js';
import tmpl from './bCDBarbersNCosmotologyIntakeFormEnglish.html';
import tmpl_nds from './bCDBarbersNCosmotologyIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBarbersNCosmotologyIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
