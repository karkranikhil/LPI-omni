...
import { OMNIDEF } from './bCDLicenseEnglish_def.js';
import tmpl from './bCDLicenseEnglish.html';
import tmpl_nds from './bCDLicenseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDLicenseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
