...
import { OMNIDEF } from './bCDCreateApplicationDocumentEnglish_def.js';
import tmpl from './bCDCreateApplicationDocumentEnglish.html';
import tmpl_nds from './bCDCreateApplicationDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCreateApplicationDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
