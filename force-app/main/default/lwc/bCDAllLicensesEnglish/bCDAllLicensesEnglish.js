...
import { OMNIDEF } from './bCDAllLicensesEnglish_def.js';
import tmpl from './bCDAllLicensesEnglish.html';
import tmpl_nds from './bCDAllLicensesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAllLicensesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
