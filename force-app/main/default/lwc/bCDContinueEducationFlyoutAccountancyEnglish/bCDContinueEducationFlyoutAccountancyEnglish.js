...
import { OMNIDEF } from './bCDContinueEducationFlyoutAccountancyEnglish_def.js';
import tmpl from './bCDContinueEducationFlyoutAccountancyEnglish.html';
import tmpl_nds from './bCDContinueEducationFlyoutAccountancyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDContinueEducationFlyoutAccountancyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
