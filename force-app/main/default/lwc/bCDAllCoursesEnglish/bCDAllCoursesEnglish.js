...
import { OMNIDEF } from './bCDAllCoursesEnglish_def.js';
import tmpl from './bCDAllCoursesEnglish.html';
import tmpl_nds from './bCDAllCoursesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAllCoursesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
