...
import { OMNIDEF } from './cCDVICEPremiseFormEnglish_def.js';
import tmpl from './cCDVICEPremiseFormEnglish.html';
import tmpl_nds from './cCDVICEPremiseFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDVICEPremiseFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
