...
import { OMNIDEF } from './lPISettlementFlowEnglish_def.js';
import tmpl from './lPISettlementFlowEnglish.html';
import tmpl_nds from './lPISettlementFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPISettlementFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
