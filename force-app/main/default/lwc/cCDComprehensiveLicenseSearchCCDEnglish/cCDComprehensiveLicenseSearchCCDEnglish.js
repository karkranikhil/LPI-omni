...
import { OMNIDEF } from './cCDComprehensiveLicenseSearchCCDEnglish_def.js';
import tmpl from './cCDComprehensiveLicenseSearchCCDEnglish.html';
import tmpl_nds from './cCDComprehensiveLicenseSearchCCDEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDComprehensiveLicenseSearchCCDEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
