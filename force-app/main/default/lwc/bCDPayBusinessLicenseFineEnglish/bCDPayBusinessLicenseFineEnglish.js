...
import { OMNIDEF } from './bCDPayBusinessLicenseFineEnglish_def.js';
import tmpl from './bCDPayBusinessLicenseFineEnglish.html';
import tmpl_nds from './bCDPayBusinessLicenseFineEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDPayBusinessLicenseFineEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
