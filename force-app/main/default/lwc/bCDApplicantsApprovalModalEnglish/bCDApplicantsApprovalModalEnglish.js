...
import { OMNIDEF } from './bCDApplicantsApprovalModalEnglish_def.js';
import tmpl from './bCDApplicantsApprovalModalEnglish.html';
import tmpl_nds from './bCDApplicantsApprovalModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDApplicantsApprovalModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
