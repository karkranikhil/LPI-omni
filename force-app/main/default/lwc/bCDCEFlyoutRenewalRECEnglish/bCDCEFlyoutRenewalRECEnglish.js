...
import { OMNIDEF } from './bCDCEFlyoutRenewalRECEnglish_def.js';
import tmpl from './bCDCEFlyoutRenewalRECEnglish.html';
import tmpl_nds from './bCDCEFlyoutRenewalRECEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCEFlyoutRenewalRECEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
