...
import { OMNIDEF } from './bCDBNCSupervisorModalEnglish_def.js';
import tmpl from './bCDBNCSupervisorModalEnglish.html';
import tmpl_nds from './bCDBNCSupervisorModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBNCSupervisorModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
