...
import { OMNIDEF } from './lPIComplaintEnglish_def.js';
import tmpl from './lPIComplaintEnglish.html';
import tmpl_nds from './lPIComplaintEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIComplaintEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
