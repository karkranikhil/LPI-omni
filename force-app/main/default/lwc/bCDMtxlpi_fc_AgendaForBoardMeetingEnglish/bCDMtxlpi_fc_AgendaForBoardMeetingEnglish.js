...
import { OMNIDEF } from './bCDMtxlpi_fc_AgendaForBoardMeetingEnglish_def.js';
import tmpl from './bCDMtxlpi_fc_AgendaForBoardMeetingEnglish.html';
import tmpl_nds from './bCDMtxlpi_fc_AgendaForBoardMeetingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMtxlpi_fc_AgendaForBoardMeetingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
