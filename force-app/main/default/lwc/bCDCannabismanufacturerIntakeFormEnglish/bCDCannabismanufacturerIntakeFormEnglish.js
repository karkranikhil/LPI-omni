...
import { OMNIDEF } from './bCDCannabismanufacturerIntakeFormEnglish_def.js';
import tmpl from './bCDCannabismanufacturerIntakeFormEnglish.html';
import tmpl_nds from './bCDCannabismanufacturerIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabismanufacturerIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
