...
import { OMNIDEF } from './bCDDuediligencestatusEnglish_def.js';
import tmpl from './bCDDuediligencestatusEnglish.html';
import tmpl_nds from './bCDDuediligencestatusEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDuediligencestatusEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
