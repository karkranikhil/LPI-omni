...
import { OMNIDEF } from './bCDJPExamStepEnglish_def.js';
import tmpl from './bCDJPExamStepEnglish.html';
import tmpl_nds from './bCDJPExamStepEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDJPExamStepEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
