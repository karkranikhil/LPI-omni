...
import { OMNIDEF } from './bCDScheduledCourseFilesEnglish_def.js';
import tmpl from './bCDScheduledCourseFilesEnglish.html';
import tmpl_nds from './bCDScheduledCourseFilesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDScheduledCourseFilesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
