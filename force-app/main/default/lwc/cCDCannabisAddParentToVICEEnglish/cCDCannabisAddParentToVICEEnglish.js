...
import { OMNIDEF } from './cCDCannabisAddParentToVICEEnglish_def.js';
import tmpl from './cCDCannabisAddParentToVICEEnglish.html';
import tmpl_nds from './cCDCannabisAddParentToVICEEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisAddParentToVICEEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
