...
import { OMNIDEF } from './bCDCannabisRetailIntakeFormEnglish_def.js';
import tmpl from './bCDCannabisRetailIntakeFormEnglish.html';
import tmpl_nds from './bCDCannabisRetailIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisRetailIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
