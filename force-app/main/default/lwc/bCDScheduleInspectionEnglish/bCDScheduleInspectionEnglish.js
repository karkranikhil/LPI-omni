...
import { OMNIDEF } from './bCDScheduleInspectionEnglish_def.js';
import tmpl from './bCDScheduleInspectionEnglish.html';
import tmpl_nds from './bCDScheduleInspectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDScheduleInspectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
