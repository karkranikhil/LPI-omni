...
import { OMNIDEF } from './bCDDueDiligenceEnglish_def.js';
import tmpl from './bCDDueDiligenceEnglish.html';
import tmpl_nds from './bCDDueDiligenceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDueDiligenceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
