...
import { OMNIDEF } from './bCDRegistrationEnglish_def.js';
import tmpl from './bCDRegistrationEnglish.html';
import tmpl_nds from './bCDRegistrationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDRegistrationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
