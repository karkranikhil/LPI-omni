...
import { OMNIDEF } from './bCDUploadApplicationDocumentEnglish_def.js';
import tmpl from './bCDUploadApplicationDocumentEnglish.html';
import tmpl_nds from './bCDUploadApplicationDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDUploadApplicationDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
