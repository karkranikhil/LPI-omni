...
import { OMNIDEF } from './bCDIssuancePaymentEnglish_def.js';
import tmpl from './bCDIssuancePaymentEnglish.html';
import tmpl_nds from './bCDIssuancePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDIssuancePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
