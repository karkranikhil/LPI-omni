...
import { OMNIDEF } from './bCDJPExamination_SWEnglish_def.js';
import tmpl from './bCDJPExamination_SWEnglish.html';
import tmpl_nds from './bCDJPExamination_SWEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDJPExamination_SWEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
