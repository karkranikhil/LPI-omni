...
import { OMNIDEF } from './lPIApplEnglish_def.js';
import tmpl from './lPIApplEnglish.html';
import tmpl_nds from './lPIApplEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIApplEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
