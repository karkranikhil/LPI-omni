...
import { OMNIDEF } from './bCDDeleteContEducation_RenewalEnglish_def.js';
import tmpl from './bCDDeleteContEducation_RenewalEnglish.html';
import tmpl_nds from './bCDDeleteContEducation_RenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDeleteContEducation_RenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
