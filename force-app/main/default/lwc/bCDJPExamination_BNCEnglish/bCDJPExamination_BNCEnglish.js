...
import { OMNIDEF } from './bCDJPExamination_BNCEnglish_def.js';
import tmpl from './bCDJPExamination_BNCEnglish.html';
import tmpl_nds from './bCDJPExamination_BNCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDJPExamination_BNCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
