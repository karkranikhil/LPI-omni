...
import { OMNIDEF } from './bCDMtxlpi_os_applicationDocumentUploadEnglish_def.js';
import tmpl from './bCDMtxlpi_os_applicationDocumentUploadEnglish.html';
import tmpl_nds from './bCDMtxlpi_os_applicationDocumentUploadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMtxlpi_os_applicationDocumentUploadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
