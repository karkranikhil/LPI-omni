...
import { OMNIDEF } from './bCDAddCNSSupervisorModalEnglish_def.js';
import tmpl from './bCDAddCNSSupervisorModalEnglish.html';
import tmpl_nds from './bCDAddCNSSupervisorModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAddCNSSupervisorModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
