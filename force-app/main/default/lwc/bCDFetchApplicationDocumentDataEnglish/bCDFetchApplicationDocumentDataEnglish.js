...
import { OMNIDEF } from './bCDFetchApplicationDocumentDataEnglish_def.js';
import tmpl from './bCDFetchApplicationDocumentDataEnglish.html';
import tmpl_nds from './bCDFetchApplicationDocumentDataEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDFetchApplicationDocumentDataEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
