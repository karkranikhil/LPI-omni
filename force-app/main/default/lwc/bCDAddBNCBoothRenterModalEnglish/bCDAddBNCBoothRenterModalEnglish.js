...
import { OMNIDEF } from './bCDAddBNCBoothRenterModalEnglish_def.js';
import tmpl from './bCDAddBNCBoothRenterModalEnglish.html';
import tmpl_nds from './bCDAddBNCBoothRenterModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAddBNCBoothRenterModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
