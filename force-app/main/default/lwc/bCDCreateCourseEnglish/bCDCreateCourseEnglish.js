...
import { OMNIDEF } from './bCDCreateCourseEnglish_def.js';
import tmpl from './bCDCreateCourseEnglish.html';
import tmpl_nds from './bCDCreateCourseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCreateCourseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
