...
import { OMNIDEF } from './bCDContinueEducationFlyoutBNCEnglish_def.js';
import tmpl from './bCDContinueEducationFlyoutBNCEnglish.html';
import tmpl_nds from './bCDContinueEducationFlyoutBNCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDContinueEducationFlyoutBNCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
