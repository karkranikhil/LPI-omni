...
import { OMNIDEF } from './bCDLicenseTypeEnglish_def.js';
import tmpl from './bCDLicenseTypeEnglish.html';
import tmpl_nds from './bCDLicenseTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDLicenseTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
