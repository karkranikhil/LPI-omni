...
import { OMNIDEF } from './cCDDisplayLicenseDetailsCCDEnglish_def.js';
import tmpl from './cCDDisplayLicenseDetailsCCDEnglish.html';
import tmpl_nds from './cCDDisplayLicenseDetailsCCDEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDDisplayLicenseDetailsCCDEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
