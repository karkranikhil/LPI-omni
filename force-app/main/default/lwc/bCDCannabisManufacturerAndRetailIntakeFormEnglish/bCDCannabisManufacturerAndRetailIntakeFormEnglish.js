...
import { OMNIDEF } from './bCDCannabisManufacturerAndRetailIntakeFormEnglish_def.js';
import tmpl from './bCDCannabisManufacturerAndRetailIntakeFormEnglish.html';
import tmpl_nds from './bCDCannabisManufacturerAndRetailIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDCannabisManufacturerAndRetailIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
