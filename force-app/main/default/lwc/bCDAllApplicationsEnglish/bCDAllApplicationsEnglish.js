...
import { OMNIDEF } from './bCDAllApplicationsEnglish_def.js';
import tmpl from './bCDAllApplicationsEnglish.html';
import tmpl_nds from './bCDAllApplicationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDAllApplicationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
