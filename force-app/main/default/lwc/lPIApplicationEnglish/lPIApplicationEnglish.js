...
import { OMNIDEF } from './lPIApplicationEnglish_def.js';
import tmpl from './lPIApplicationEnglish.html';
import tmpl_nds from './lPIApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lPIApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
