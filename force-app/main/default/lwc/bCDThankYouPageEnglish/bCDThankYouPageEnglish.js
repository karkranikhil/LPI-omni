...
import { OMNIDEF } from './bCDThankYouPageEnglish_def.js';
import tmpl from './bCDThankYouPageEnglish.html';
import tmpl_nds from './bCDThankYouPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDThankYouPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
