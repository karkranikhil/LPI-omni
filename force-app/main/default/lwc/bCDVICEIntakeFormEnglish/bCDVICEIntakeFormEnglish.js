...
import { OMNIDEF } from './bCDVICEIntakeFormEnglish_def.js';
import tmpl from './bCDVICEIntakeFormEnglish.html';
import tmpl_nds from './bCDVICEIntakeFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDVICEIntakeFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
