...
import { OMNIDEF } from './cCDCannabisVICEAttestationsEnglish_def.js';
import tmpl from './cCDCannabisVICEAttestationsEnglish.html';
import tmpl_nds from './cCDCannabisVICEAttestationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cCDCannabisVICEAttestationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
