...
import { OMNIDEF } from './bCDBoardsEnglish_def.js';
import tmpl from './bCDBoardsEnglish.html';
import tmpl_nds from './bCDBoardsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBoardsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
