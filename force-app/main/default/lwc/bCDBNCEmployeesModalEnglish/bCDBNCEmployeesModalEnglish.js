...
import { OMNIDEF } from './bCDBNCEmployeesModalEnglish_def.js';
import tmpl from './bCDBNCEmployeesModalEnglish.html';
import tmpl_nds from './bCDBNCEmployeesModalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDBNCEmployeesModalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
