...
import { OMNIDEF } from './bCDSocialWorkRenewalEnglish_def.js';
import tmpl from './bCDSocialWorkRenewalEnglish.html';
import tmpl_nds from './bCDSocialWorkRenewalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDSocialWorkRenewalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
