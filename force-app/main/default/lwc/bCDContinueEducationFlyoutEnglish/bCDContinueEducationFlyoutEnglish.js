...
import { OMNIDEF } from './bCDContinueEducationFlyoutEnglish_def.js';
import tmpl from './bCDContinueEducationFlyoutEnglish.html';
import tmpl_nds from './bCDContinueEducationFlyoutEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDContinueEducationFlyoutEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
