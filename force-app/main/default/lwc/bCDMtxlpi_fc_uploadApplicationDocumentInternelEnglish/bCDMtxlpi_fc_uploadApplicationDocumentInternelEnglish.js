...
import { OMNIDEF } from './bCDMtxlpi_fc_uploadApplicationDocumentInternelEnglish_def.js';
import tmpl from './bCDMtxlpi_fc_uploadApplicationDocumentInternelEnglish.html';
import tmpl_nds from './bCDMtxlpi_fc_uploadApplicationDocumentInternelEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDMtxlpi_fc_uploadApplicationDocumentInternelEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
