...
import { OMNIDEF } from './bCDProfile_pageEnglish_def.js';
import tmpl from './bCDProfile_pageEnglish.html';
import tmpl_nds from './bCDProfile_pageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDProfile_pageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
