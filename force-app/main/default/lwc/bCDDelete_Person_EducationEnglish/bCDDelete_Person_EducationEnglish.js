...
import { OMNIDEF } from './bCDDelete_Person_EducationEnglish_def.js';
import tmpl from './bCDDelete_Person_EducationEnglish.html';
import tmpl_nds from './bCDDelete_Person_EducationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bCDDelete_Person_EducationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
